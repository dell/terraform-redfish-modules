docs:
	...
	terraform-docs markdown table --output-file README.md --output-mode inject modules/redfish_users/
	terraform-docs markdown table --output-file README.md --output-mode inject examples/users/