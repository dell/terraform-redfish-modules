...
* Contribute to the Terraform module for Dell iDRAC Redfish documentation and codebase.
...
All issues related to Terraform module for Dell iDRAC Redfish, regardless of the service/repository the issue belongs to (see table above), should be submitted [here](https://github.com/dell/dell-terraform-providers/issues). Issues will be triaged and labels will be used to indicate the type of issue. This section outlines the types of issues that can be submitted.  

### Report bugs

We aim to track and document everything related to Terraform module for Dell iDRAC Redfish via the Issues page. The code and documentation are released with no warranties or SLAs and are intended to be supported through a community driven process.
...
We'd love your help answering questions being asked by other Terraform module for Dell iDRAC Redfish users.
...
If you don't have the knowledge or time to code, consider helping with _issue triage_. The Terraform module for Dell iDRAC Redfish community will thank you for saving them time by spending some of yours.
